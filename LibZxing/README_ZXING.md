...
- ```thresholdBlock``` - пременяет пороговую яркость, для пикселей меньше порога присваивается черный цвет (0), а для больших белый (1). 
